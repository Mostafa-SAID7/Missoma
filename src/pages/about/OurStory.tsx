        ...
        <main className="w-full lg:w-[70vw] lg:ml-auto px-6">
          ...
          <ContentSection>
            <ImageTextBlock
              ...
              content="Missoma Jewelry was born from a shared vision of creating timeless pieces that transcend fleeting trends. Our founders, united by their passion for exceptional craftsmanship and sustainable practices, established the brand with a commitment to creating jewelry that tells a story - your story."
              imagePosition="left"
            />
          </ContentSection>
